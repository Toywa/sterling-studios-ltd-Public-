  ...
  return (
    <div className="bg-white">
      ...
      <article className="max-w-3xl mx-auto px-6 lg:px-8 pt-16 pb-20">
        ...
        <div className="mt-4 text-[13px] text-slate-500">By David Toywa • Founder, Sterling Studios • 8 min read • Updated Jan 2026</div>
        ...
        <div className="mt-10 space-y-6 text-[16px] leading-8 text-slate-700">
          ...
          <h2 className="text-[22px] font-bold text-slate-900 mt-8">3. Code (Node.js) — Production</h2>
