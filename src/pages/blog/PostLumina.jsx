  ...
  return (
    <div className="bg-white">
      ...
      <article className="max-w-3xl mx-auto px-6 lg:px-8 pt-16 pb-20">
        ...
        <div className="mt-4 text-[13px] text-slate-500">Case study • 6 min • Dec 2025</div>
        ...
        <div className="mt-10 space-y-6 text-[16px] leading-8 text-slate-700">
          ...
          <p><b>Result:</b> 3h → 8 min reconciliation, 96.4% success, 8s avg, -60% support calls, KES 12.4M weekly now tracked.</p>
          <div className="p-6 rounded-[20px] bg-slate-50 border"><div className="font-bold">Want similar dashboard?</div><div className="text-[14px] mt-2"><a href="/work/luminapay" className="underline">See full case study →</a> or <a href="https://wa.me/254722114098" className="underline font-bold">WhatsApp us</a></div></div>
        </div>
      </article>
    </div>
  )
