...
export default function PostSpeed(){
  return (
    <div className="bg-white">
      <SEO title="Why 95+ Lighthouse Speed Matters: AURORA 3x Enquiries | Sterlings Studio" description="How we rebuilt AURORA wealth site from 62 to 95+ Lighthouse, 3x enquiries, 42% longer time. Next.js, Tailwind, Vercel, SEO. By Sterlings Studio Nairobi." canonical="https://sterlingsstudio.com/blog/why-95-lighthouse-speed-matters" />
      <article className="max-w-3xl mx-auto px-6 lg:px-8 pt-16 pb-20">
        <div className="text-[11px] tracking-widest font-bold text-slate-400">PERFORMANCE â€¢ AURORA â€¢ SEO</div>
        ...
        <div className="mt-4 text-[13px] text-slate-500">5 min â€¢ Nov 2025</div>
        ...
        <div className="mt-10 space-y-6 text-[16px] leading-8 text-slate-700">
          ...
          <div className="p-6 rounded-[20px] bg-slate-50 border"><div className="font-bold">Want 95+ speed?</div><div className="text-[14px] mt-2"><a href="/work/aurora" className="underline">See AURORA case study â†’</a></div></div>
        </div>
      </article>
    </div>
  )
