    ...
    <div className="bg-white text-slate-900">
      <section className="max-w-[1280px] mx-auto px-6 lg:px-8 pt-14 pb-20">
        <div className="grid lg:grid-cols-[1.05fr_0.95fr] gap-12 items-start">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-50 border text-[11px] font-bold tracking-widest">
              EST. NAIROBI • BUILDING FOR AFRICA & GLOBAL
            </div>

            <h1 className="mt-6 text-[42px] lg:text-[64px] font-extrabold leading-[0.9] tracking-tight">
              Websites that load in 0.8s.
              <br />
              Apps that scale.
              <br />
            ...
            <p className="mt-6 text-[16px] leading-7 text-slate-600 max-w-[54ch]">
              We are Sterling Studios — a team of developers building fast,
              beautiful, secure products. No WordPress, no templates. We code
              everything from scratch so it performs, ranks, and converts.
            </p>
          ...
          <div className="space-y-4">
            <div className="rounded-[24px] overflow-hidden border">
              <img
                ...
                alt="Team presenting in Nairobi boardroom"
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="rounded-[20px] overflow-hidden border">
                ...
                <div className="p-3 text-[12px]">
                  <div className="font-bold">Founder-led</div>
                  <div className="text-slate-500">
                    Real founders using our products
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-[20px] overflow-hidden border">
                ...
                <div className="p-3 text-[12px]">
                  <div className="font-bold">Team-built</div>
                  <div className="text-slate-500">
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            <div className="rounded-[24px] border bg-white overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="mt-2 font-bold">
                  Corporate sites and landing pages that rank and convert.
                  0.8s load, 95+ Lighthouse.
                </div>
              </div>
            </div>
            ...
            <div className="rounded-[24px] border bg-white overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="mt-2 font-bold">
                  Dashboards, portals, and SaaS with roles, audits, and
                  real-time data.
                </div>
              </div>
            </div>
            ...
            <div className="rounded-[24px] border bg-white overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="mt-2 font-bold">
                  Android and iOS apps, offline-first, one codebase. Native
                  feel.
                </div>
              </div>
            </div>
